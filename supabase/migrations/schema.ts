import { pgTable, pgEnum, serial, text, timestamp, jsonb, json } from "drizzle-orm/pg-core"
...
export const code_snippets = pgTable("code_snippets", {
	post_slug: text("post_slug").primaryKey().notNull(),
	images: json("images"),
});